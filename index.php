...
<style>
  ...
  *{ box-sizing:border-box; }
  ...
  .nav .brand{ display:flex; align-items:center; gap:10px; padding:0 20px 18px; margin:0 0 10px; border-bottom:1px solid rgba(255,255,255,.15); }
  .nav .brand-logo{ width:38px; height:38px; flex:0 0 auto; }
  .nav .brand-org{ font-size:10.5px; font-weight:600; letter-spacing:.03em; color:rgba(255,255,255,.72); margin:0 0 2px; }
  .nav .brand-title{ font-size:13.5px; font-weight:700; letter-spacing:.02em; color:#fff; line-height:1.45; margin:0; word-break:keep-all; }
  .nav button{
